  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        ...
        <a class="btn btn-primary" href="addShoe.php" role="button">Add Toys</a>
          <table id="tableShoe">
            <tr>
              <th class="text-center" style="min-width:50px">STT</th>
              <th class="text-center" style="min-width:50px">ID</th>
              <th class="text-center" style="min-width:150px">Name Toys</th>
              <th class="text-center" style="min-width:150px">Price</th>
              <th class="text-center" style="min-width:50px">Sale</th>
              <th class="text-center" style="min-width:100px">Size</th>
              <th class="text-center" style="min-width:100px">Color</th>
              <th class="text-center" style="min-width:100px">Category</th>
              <th class="text-center" style="min-width:200px">Introduc Code</th>
            ...
            <tr>
                ...
                <td><a class="btn btn-warning" href="updateShoe.php?id=<?php echo $shoe['shoe_id']?>" role="button">Update</a></td>
                <td><a class="btn btn-danger" href="deleteShoe.php?id=<?php echo $shoe['shoe_id']?>" role="button" onclick="return confirm('You sure?');">Delete</a></td>
            </tr>
            <?php
                  }
            ?>
