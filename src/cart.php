      ...
      <div class="header__top">
        ...
        <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-6 col-xs-12 ">
                  <p>Hạ đoạn3, P.Đông Hải, Q.Hải An, TP.Hải Phòng  -  Hotline: 0934499331</p>
                </div>
        ...
        <div class="container-fluid">
          ...
          <div class="navigation__column center">
                <ul class="main-menu menu">
                  ...
                  <li class="menu-item menu-item-has-children has-mega-menu"><a href="#">Robot</a></li>
                  <li class="menu-item"><a href="#">oto</a></li>
                  <li class="menu-item"><a href="#">lego</a></li>
                  <li class="menu-item menu-item-has-children dropdown"><a href="#">bupbe</a>
