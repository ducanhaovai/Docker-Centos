        ...
        <div class="container-fluid">
          <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-6 col-xs-12 ">
                  <p>Ha Doan 3, P.DongHAi, Q.HaiAn, TP.HaiPhong  -  Hotline: 0934499331</p>
                </div>
      ...
      <nav class="navigation">
        <div class="container-fluid">
          <div class="navigation__column left">
            <div class="header__logo"><a class="ps-logo" href="index.php"><img src="images/logobtec.png" alt=""></a></div>
          </div>
          <div class="navigation__column center">
                <ul class="main-menu menu">
                  <li class="menu-item menu-item-has-children dropdown"><a href="index.php">Home</a>
                  </li>
                  <li class="menu-item menu-item-has-children has-mega-menu"><a href="#">robot</a>
                  </li>
                  <li class="menu-item"><a href="#">oto</a></li>
                  <li class="menu-item"><a href="#">Lego</a></li>
                  <li class="menu-item menu-item-has-children dropdown"><a href="#">Bup Be</a>
                       
                  </li>
                  <li class="menu-item menu-item-has-children dropdown"><a href="contact-us.php">Kids</a>
                  </li>
                </ul>
          </div>
    ...
    <main class="ps-main">
      <div class="ps-banner">
        <div class="rev_slider fullscreenbanner" id="home-banner">
          <ul>
            <li class="ps-banner" data-index="rs-2972" data-transition="random" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-rotate="0"><img class="rev-slidebg" src="images/background/logoslide1.png" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" data-no-retina>
            ...
            <li class="ps-banner ps-banner--white" data-index="rs-100" data-transition="random" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-rotate="0"><img class="rev-slidebg" src="images/background/logoslide2.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" data-no-retina>
        ...
        <div class="ps-container">
          <div class="ps-section__header mb-50">
            ...
            <ul class="ps-masonry__filter">
              ...
              <li><a href="#" data-filter=".nike">robot<sup><?php  echo $shoeRepository->countShoeByCategoryName('Robot');?></sup></a></li>
              <li><a href="#" data-filter=".adidas">Oto <sup><?php  echo $shoeRepository->countShoeByCategoryName('oto');?></sup></a></li>
              <li><a href="#" data-filter=".men">Lego <sup><?php  echo $shoeRepository->countShoeByCategoryName('lego');?></sup></a></li>
              <li><a href="#" data-filter=".women">Bup be <sup><?php  echo $shoeRepository->countShoeByCategoryName('bup be');?></sup></a></li>
      ...
      <div class="ps-section--offer">
        <div class="ps-column"><a class="ps-offer" href="product-listing.php"><img id="imageShoeBanner" src="images/lego1.jpg" alt=""></a></div>
        <div class="ps-column"><a class="ps-offer" href="product-listing.php"><img id="imageShoeBanner" src="images/banner/nhiem-vu-sao-tho.jpg" alt=""></a></div>
      </div>
      ...
      <div class="ps-home-testimonial bg--parallax pb-80" data-background="images/banner/sauce.jpg">
        <div class="container">
          <div class="owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="false" data-owl-dots="true" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="on" data-owl-animate-in="fadeIn" data-owl-animate-out="fadeOut">
            <div class="ps-testimonial">
              <div class="ps-testimonial__thumbnail"><img src="images/banner/hoacai.jpg" alt=""><i class="fa fa-quote-left"></i></div>
              <header>
            ...
            <form action="" method="post">
              ...
              <?php
                if(isset($_POST['send_email']))
                  $sendEmail->send($_POST['name'],$_POST['email'],"Hello",$_POST['content']);
              ?>
            </form>
          </footer>
        </div>
      ...
      <div class="ps-footer bg--cover" data-background="images/logobtec.png">
        <div class="ps-footer__content">
          <div class="ps-container">
            <div class="row">
                  <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
                    <aside class="ps-widget--footer ps-widget--info">
                      <header><a class="ps-logo" href="index.php"><img src="images/logobtec.png" alt=""></a>
                        <h3 class="ps-widget__title">Address Office 1</h3>
                      </header>
                      <footer>
                        <p><strong>Ha Doan 3, P.DongHAi, Q.HaiAn, TP.HaiPhong</strong></p>
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
                    <aside class="ps-widget--footer ps-widget--info second">
                      ...
                      <footer>
                        <p><strong>43Hoang Minh Thao, Q.Lê Chân, TP.Hải Phòng</strong></p>
                        <p>Email: <a href='mailto:support@store.com'>support@store.com</a></p>
                        <p>Phone: 0868699999</p>
        ...
        <div class="ps-footer__copyright">
          <div class="ps-container">
            <div class="row">
                  ...
                  <p>&copy; <a href="#">Web</a>, Inc. All rights Resevered. Design by <a href="">Văn Toàn</a></p>
                  </div>
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                    <ul class="ps-social">
                      <li><a href="https://www.facebook.com/V.toan203"><i class="fa fa-facebook"></i></a></li>
                      <li><a href="https://www.instagram.com/v.toan203/"><i class="fa fa-instagram"></i></a></li>
                    </ul>
                  </div>
            </div>
          </div>
