...
<html lang="en">
  ...
  <body class="ps-loading">
    ...
    <main class="ps-main">
              ...
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  ...
                  <div class="ps-shoe__content">
                    ...
                    <div class="ps-shoe__detail"><a class="ps-shoe__name" href="product-detai.php"></a>
                      <p class="ps-shoe__categories"><a href="#">Men shoes</a>,<a href="#"> Nike</a>,<a href="#"></a></p><span class="ps-shoe__price"> £ 120</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
                  <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
                    <div class="ps-product--hotdeal reverse">
                      ...
                      <div class="ps-product__content"><a class="ps-product__title text-uppercase" href="product-detail.php"></a>
                        <p class="ps-product__price">Only: <span>£178</span></p>
                        <div class="ps-product__status">
                          <div class="sold">Already sold: <span>10</span></div>
                          <div class="avaiable">Avaiable: <span>30</span></div>
      ...
      <div class="ps-home-testimonial bg--parallax pb-80" data-background="images/logobtec.jpg">
        <div class="container">
