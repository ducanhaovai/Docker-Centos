        ...
        <div class="right_col" role="main">
          <table id="tableShoe">
            <tr>
              ...
              <th class="text-center" style="min-width:150px">Name Customer</th>
              <th class="text-center" style="min-width:150px">Address</th>
              <th class="text-center" style="min-width:150px">Name Toy</th>
              ...
              <th class="text-center" style="min-width:100px">Date Oder</th>
            ...
            <tr>
                ...
                <td><?php
                    if($order['status'] == 2){
                 ?>
                 <a class="btn btn-warning" href="acceptOrder.php?id=<?php echo $order['cart_id']?>" role="button">Submit</a>
                 <?php 
                    }
                ?>
                <?php
                    if($order['status'] == 3){
                 ?>
                 <a class="btn btn-success" href="#" role="button">Approved</a>
                 <?php 
                    }
                ?>
                 </td>
                ...
                <?php
                    if($order['status'] == 2){
                 ?>
                  <a class="btn btn-danger" href="deleteOrder.php?id=<?php echo $order['order_id']?>" role="button" onclick="return confirm('You Sure?');">Cancel Order</a></td>
                 <?php 
                    }
                ?>
