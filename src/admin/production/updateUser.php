    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="form-group">
          ...
          <input required value="<?php echo $userInfo['fullname']?>" minlength="5" maxlength="50" name="fullname" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Fullname">
        </div>
        <div class="form-group">
          <label for="exampleInputPassword1">Email</label>
          <input required value="<?php echo $userInfo['email']?>" minlength="5" maxlength="50" name="email" type="email" class="form-control" id="exampleInputPassword1" placeholder="Email">
        </div>
        <div class="form-group">
          <label for="exampleInputPassword1">SDT</label>
          <input required value="<?php echo $userInfo['phone']?>" minlength="0" maxlength="10" name="phone" type="number" class="form-control" id="exampleInputPassword1" placeholder="sdt">
        </div>
        <div class="form-group">
